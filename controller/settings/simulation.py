...
SIMS_SETTINGS.append({'name': 'find_limits_linear',
                      ...
                      'magnitude_init_list':   np.array([.5]*12), #np.array([1.5, 1.4, 1.7, 2.2, 1.9, 2.2, 2.8, 2.2, 1.9, 2.1, 1.7, 1.4]),
                      'useWBC': True,
                      'useIK': False,
                      'typeWBC': 'projection',  # or 'qp' (used only if useWBC is True)
                      'id': '',
...
SIMS_SETTINGS.append({'name': 'find_limits_linear',
                      'pose': np.array([0., 0., 0.85, 0., 0., 0.]),
                      'twist': np.array([0, 0., 0., 0., 0., 0.]),
                      'magnitude_init_list':  np.array([.5]*12),#np.array([3.0, 3.3, 2.7, 2.3, 2.1, 2.1, 2.2, 2.1, 2.0, 2.3, 2.7, 3.3]),
                      'useWBC': True,
                      'useIK': False,
                      'typeWBC': 'projection',  # or 'qp' (used only if useWBC is True)
                      'id': '',
...
SIMS_SETTINGS.append({'name': 'find_limits_linear',
                      ...
                      'twist': np.array([0, 0., 0., 0., 0., 0.]),
                      'magnitude_init_list':  np.array([.5]*12),#np.array([2.6, 2.2, 1.6, 1.3, 1.7, 1.3, 2.2, 1.1, 1.7, 1.4, 1.6, 2.1]),
                      'useWBC': True,
                      'useIK': False,
                      'typeWBC': 'projection',  # or 'qp' (used only if useWBC is True)
                      'id': '',
