...
# kinematic region: where the com can go due to the kinematic limits
...
# kinematic and friction region: where the com can go due to both the kinematic limits AND the static stability
# it is the intersection between the kinematic region and the support polygon
KIN_and_FRIC_REG = []
...
# trasform to 2d arrays
# KIN_REG = np.concatenate(KIN_REG)
# KIN_and_FRIC_REG = np.concatenate(KIN_and_FRIC_REG)
